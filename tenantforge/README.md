...
[![version](https://img.shields.io/badge/version-0.38.1-blue)](https://github.com/0xb007ab1e/neon-tools/releases/tag/tenantforge-v0.38.1)
...
**Status:** `stable` (v0.38.1) — feature-complete and hardened. Implemented: the pure core
