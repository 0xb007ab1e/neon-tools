...
[![version](https://img.shields.io/badge/version-0.10.0-blue)](https://github.com/0xb007ab1e/neon-tools/releases/tag/tenantforge-v0.10.0)
...
**Status:** `stable` (v0.10.0) — feature-complete and hardened. Implemented: the pure core
