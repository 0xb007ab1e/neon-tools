...
describe('dashboard App', () => {
  it('shows the login form when unauthenticated, with no a11y violations', async () => {
  ...
  it('logs in and renders the compliance panel (residency violation shown), no a11y violations', async () => {
    const { container } = render(<App />);
    ...
    // The residency violation from the report is surfaced in the panel.
