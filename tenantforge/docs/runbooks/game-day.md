...
NEON_API_KEY rotation was drilled (suite re-run 10/10 on the rotated key), and the Neon PITR restore
was drilled with a row-level recovery proof (2026-06-18). **All runbook gates drilled.** Owner:
TenantForge maintainers._
